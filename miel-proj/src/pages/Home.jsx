...
const Section = ({ children, background, custom }) => (
  <motion.section
    className="relative flex flex-col items-center justify-center text-center p-8 overflow-hidden my-8 min-h-screen rounded-xl"
    initial="hidden"
    whileInView="visible"
    viewport={{ once: true }}
    custom={custom}
...
>
  ...
  <motion.div
    className="w-full md:w-1/2 h-64 md:h-full bg-cover bg-center rounded-xl shadow-lg"
    style={{
